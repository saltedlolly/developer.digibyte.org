...
::
   ...
   digibyte-cli -regtest setgenerate true 101

   ## Bitcoin Core 17.1 and earlier
   digibyte-cli -regtest generate 101

   ## Bitcoin Core 18.0 and later
   digibyte-cli -regtest generatetoaddress 101 $(digibyte-cli -regtest getnewaddress)
...
::
   ...
   digibyte-cli -regtest getbalance
   50.00000000

Verify that we now have 50 bitcoins available to spend.

You can now use Bitcoin Core `RPCs <../reference/rpc/index.html>`__ prefixed with ``digibyte-cli -regtest``.
